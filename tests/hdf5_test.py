...
from biosimulations_runutils.biosim_pipeline.hdf5_compare import get_results, compare_arrays, compare_datasets


def test_compare_arrays() -> None:
    results_zip: Path = Path("fixtures/modeldb-206365-outputs.zip")
    a = results_zip.absolute()
